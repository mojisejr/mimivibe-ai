            ...
            <div className="grid gap-4 md:grid-cols-3">
              <div className="text-center p-4 border rounded-lg">
                <div className="text-2xl font-bold text-red-500">
                  {metrics.recentActivity.failedLogins}
                </div>
                <p className="text-sm text-muted-foreground">Failed Logins</p>
              </div>
              <div className="text-center p-4 border rounded-lg">
                <div className="text-2xl font-bold text-orange-500">
                  {metrics.recentActivity.suspiciousRequests}
                </div>
              ...
              <div className="text-center p-4 border rounded-lg">
                <div className="text-2xl font-bold text-yellow-500">
                  {metrics.recentActivity.rateLimitHits}
                </div>
                ...
                >
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <div
                        className={`badge ${getSeverityColor(alert.severity)}`}
                      >
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-center gap-2 mt-6">
              <Button
                ...
                size="sm"
                onClick={() =>
                  fetchAlerts(currentPage - 1, searchTerm, severityFilter)
                }
