...
export default authMiddleware({
  ...
  ignoredRoutes: ["/api/webhooks/(.*)", "/api/health", "/api/payments/packages", "/api/payments/webhook", "/api/referrals/validate", "/api/cards", "/api/dev/set-admin", "/api/debug-auth", "/api/admin/force-session-refresh", "/api/readings/process", "/api/readings/ask", "/api/readings/test-async"],
