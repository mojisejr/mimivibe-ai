...
export const ERROR_MESSAGES: ErrorMapping = {
  ...
  // Async-specific error mappings
  'INSUFFICIENT_CREDITS': {
    title: 'เครดิตไม่เพียงพอ',
    message: 'คุณไม่มีเครดิตเพียงพอสำหรับการทำนาย',
    suggestion: 'กรุณาเติมเครดิตหรือแลกเหรียญเป็นคะแนนฟรี'
  },

  'SUBMISSION_FAILED': {
    title: 'การส่งคำถามล้มเหลว',
    message: 'ไม่สามารถส่งคำถามเพื่อทำนายได้ในขณะนี้',
    suggestion: 'กรุณาตรวจสอบการเชื่อมต่ออินเทอร์เน็ตและลองใหม่อีกครั้ง'
  },

  'DATABASE_ERROR': {
    title: 'เกิดข้อผิดพลาดของฐานข้อมูล',
    message: 'ระบบไม่สามารถบันทึกข้อมูลได้ในขณะนี้',
    suggestion: 'กรุณาลองใหม่อีกครั้งในอีกสักครู่'
  },

  'ASYNC_PROCESSING_ERROR': {
    title: 'เกิดข้อผิดพลาดในการประมวลผลแบบอะซิงค์',
    message: 'ระบบไม่สามารถเริ่มการประมวลผลการทำนายได้',
    suggestion: 'กรุณาลองส่งคำถามใหม่อีกครั้ง'
  },
