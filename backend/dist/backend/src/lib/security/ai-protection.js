...
exports.validateTarotQuestion = validateTarotQuestion;
exports.calculateUserSuspicionLevel = calculateUserSuspicionLevel;
exports.comprehensiveSecurityCheck = comprehensiveSecurityCheck;
...
function analyzeUserInput(input, userAgent, ip) {
    ...
    const sanitizedContent = (0, validations_1.sanitizeString)(input, 2000);
    ...
    if (riskLevel === RiskLevel.HIGH || riskLevel === RiskLevel.CRITICAL) {
        const securityEvent = {
            type: 'AI_ABUSE',
            severity: riskLevel === RiskLevel.CRITICAL ? 'CRITICAL' : 'HIGH',
            ip: ip || 'unknown',
        ...
        (0, security_1.logSecurityEvent)(securityEvent);
    }
    return {
        riskLevel,
        isBlocked,
...
function calculateUserSuspicionLevel(recentQuestions, timeWindow = 3600000 // 1 hour in milliseconds
) {
...
function comprehensiveSecurityCheck(input, userAgent, ip, recentQuestions = []) {
...
//# sourceMappingURL=ai-protection.js.map